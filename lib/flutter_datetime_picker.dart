...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? DatePickerLibTheme(),
  ...
  final DatePickerLibTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    DatePickerLibTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(DatePickerLibTheme theme) {
  ...
  Widget _renderItemView(DatePickerLibTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DatePickerLibTheme theme) {
